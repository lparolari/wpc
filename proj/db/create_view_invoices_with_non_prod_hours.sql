...
create view invoices_with_non_prod_hours (id, emitted_at, gross, tax, net, from_dt, to_dt, note, customer_id, hours) as
select 
...
where w.prod = 0
group by i.id, i.emitted_at, i.gross, i.tax, i.net, i.from_dt, i.to_dt, i.note, i.customer_id