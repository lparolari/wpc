...
create view invoices_with_hours (id, emitted_at, gross, tax, net, from_dt, to_dt, note, customer_id, hours_prod, hours_non_prod) as
...
select i.id, i.emitted_at, i.gross, i.tax, i.net, i.from_dt, i.to_dt, i.note, i.customer_id, i.hours, 0
from invoices_with_prod_hours i
where i.id not in (select id from invoices_with_non_prod_hours)

union

select i.id, i.emitted_at, i.gross, i.tax, i.net, i.from_dt, i.to_dt, i.note, i.customer_id, 0, i.hours
